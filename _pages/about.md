...
Research Interest 1: Multimodal Reasoning Foundations
I study the algorithmic foundations of reasoning in multimodal large language models, aiming to enable trustworthy and interpretable decision-making across images, video, and text. My focus is on grounding reasoning in perceptual evidence and reducing reliance on language priors.

Research Interest 2: Agentic Reinforcement Learning and Adaptive Perception
I am interested in agentic reinforcement learning for adaptive perception and tool-augmented planning-and-acting loops. My goal is to build efficient agents that learn when and how to acquire multimodal information to support scalable and reliable decision-making. <span style="color:#dc2626">I am actively seeking a Ph.D. position beginning in Fall 2026! Feel free to email me if you are interested.</span>
